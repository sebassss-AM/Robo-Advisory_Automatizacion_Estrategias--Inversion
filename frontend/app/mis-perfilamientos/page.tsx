        ...
        <div className="relative mx-auto flex max-w-5xl items-center justify-between px-6 py-4">
          ...
          <nav className="flex items-center gap-1 sm:gap-3 min-h-[36px]">
            <div className="hidden sm:flex items-center gap-1 sm:gap-3">
              <a href="/dashboard" className="btn-ghost text-sm whitespace-nowrap">Dashboard</a>
              <span className="btn-ghost text-sm whitespace-nowrap text-blue-600 font-semibold">Mis Perfilamientos</span>
              <NotificationBell />
          ...
          {menuOpen && (
            <div className="sm:hidden absolute left-0 right-0 top-full border-b border-gray-100 bg-white shadow-lg animate-fade-in">
              <div className="flex flex-col gap-1 px-4 py-3">
                ...
                <span className="rounded-lg px-3 py-2.5 text-sm font-semibold text-blue-600">
                  Mis Perfilamientos
                </span>
